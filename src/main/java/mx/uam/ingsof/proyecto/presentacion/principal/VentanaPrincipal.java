...
public class VentanaPrincipal extends JFrame {
	...
	public VentanaPrincipal() {
		 ...
		 * 
		 * 
		 * MENU BAR (PRINCIPAL) Catálogo, Clientes, Ventas Compras, Reparaciones,
		 * Proveedores
		 * 
		 ***********************************/
		...
		// Se asigna un FlowLAyout a menuBar para que esten centrados los titulos y se
		// recorran automaticamente y ajusten, el 90 es pix de separacion de ancho y 0
		// de alto
		...
		// Se crea menu menuProveedores con tipo de letra y diseño y se agrega a menu
		// bar
		 ...
		 * 
		 * 
		 * MENU CATALAGO CON SUS SUBMENUS Agregar nuevo, Modificar producto, Eliminar,
		 * Buscador
		 * 
		 ***********************************/

		// Se crea menuItemAgregar para Catalogo y su boton de acciones (menuItem =
		// Submenu)
		...
		// Se le pone a menuItemAgregar tipo de letra y diseño y se agrega a
		// menuCatalogo
		menuItemAgregar.setFont(fuente);
		menuCatalogo.add(menuItemAgregar);

		// Se crea menuItemModificar para Catalogo y su boton de acciones (menuItem =
		// Submenu)
		...
		// Se le pone a menuItemModificar tipo de letra y diseño y se agrega a
		// menuCatalogo
		menuItemModificar.setFont(fuente);
		menuCatalogo.add(menuItemModificar);

		// Se crea menuItemBuscador para Catalogo y su boton de acciones (menuItem =
		// Submenu)
		...
		// Se le pone a menuItemBuscador tipo de letra y diseño y se agrega a
		// menuCatalogo
		 ...
		 * 
		 * 
		 * MENU CLIENTES CON SUS SUBMENUS Nuevo cliente, Buscar Cliente, Modificar
		 * Cliente, Historial
		 * 
		 ***********************************/

		// Se crea menuItemNuevoCliente para Clientes y su boton de acciones (menuItem =
		// Submenu)
		...
		// Se le pone a menuItemNuevoCliente tipo de letra y diseño y se agrega a
		// menuCatalogo
		menuItemNuevoCliente.setFont(fuente);
		menuClientes.add(menuItemNuevoCliente);

		// Se crea menuItemBuscarCliente para Clientes y su boton de acciones (menuItem
		// = Submenu)
		JMenuItem menuItemBuscarCliente = new JMenuItem("Buscar Cliente");
		menuItemBuscarCliente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				controlPrincipal.buscarClientes();
			}
		});
		// Se le pone a menuItemBuscarCliente tipo de letra y diseño y se agrega a
		// menuCatalogo
		menuItemBuscarCliente.setFont(fuente);
		menuClientes.add(menuItemBuscarCliente);

		// Se crea menuItemModificarCliente para Clientes y su boton de acciones
		// (menuItem = Submenu)
		...
		// Se le pone a menuItemModificarCliente tipo de letra y diseño y se agrega a
		// menuCatalogo
		menuItemModificarCliente.setFont(fuente);
		menuClientes.add(menuItemModificarCliente);

		// Se crea menuItemHistorial para Clientes y su boton de acciones (menuItem =
		// Submenu)
		...
		// Se le pone a menuItemHistorial tipo de letra y diseño y se agrega a
		// menuCatalogo
		 ...
		 * 
		 * 
		 * MENU VENTAS CON SUS SUBMENUS Nueva venta, Garantías, Más vendidos, Mostrar
		 * ventas
		 * 
		 ***********************************/

		// Se crea menuItemNuevaVenta para Ventas y su boton de acciones (menuItem =
		// Submenu)
		...
		// Se le pone a menuItemNuevaVenta tipo de letra y diseño y se agrega a
		// menuVentas
		menuItemNuevaVenta.setFont(fuente);
		menuVentas.add(menuItemNuevaVenta);

		// Se crea menuItemGarantias para Ventas y su boton de acciones (menuItem =
		// Submenu)
		...
		// Se le pone a menuItemGarantias tipo de letra y diseño y se agrega a
		// menuVentas
		menuItemGarantias.setFont(fuente);
		menuVentas.add(menuItemGarantias);

		/*
		 * ESTÁ PENDIENTE SABER SI SE QUITA O NO // Se crea menuItemMasVendidos para
		 * Ventas y su boton de acciones (menuItem = Submenu) JMenuItem
		 * menuItemMasVendidos = new JMenuItem("Más Vendidos");
		 * menuItemMasVendidos.addActionListener(new ActionListener() { public void
		 * actionPerformed(ActionEvent e) {
		 * controlPrincipal.listaProductosMasComprados(); } }); // Se le pone a
		 * menuItemMasVendidos tipo de letra y diseño y se agrega a menuVentas
		 * menuItemMasVendidos.setFont(new Font("Sitka Subheading", Font.PLAIN, 15));
		 * menuVentas.add(menuItemMasVendidos);
		 */

		// Se crea menuItemMostrarVentas para Ventas y su boton de acciones (menuItem =
		// Submenu)
		...
		// Se le pone a menuItemMostrarVentas tipo de letra y diseño y se agrega a
		// menuVentas
		 ...
		 * 
		 * 
		 * MENU COMPRAS CON SUS SUBMENUS Nueva compra, Mostrar inversiones
		 * 
		 ***********************************/

		// Se crea menuItemNuevaCompra para Compras y su boton de acciones (menuItem =
		// Submenu)
		...
		// Se crea menuItemMostrarInversiones para Compras y su boton de acciones
		// (menuItem = Submenu)
		 ...
		 * 
		 * 
		 * MENU REPARACIÓN CON SUS SUBMENUS Nueva reparación, Pruebas de reparación
		 * 
		 ***********************************/

		// Se crea menuItemNuevaReparacion para Reparacion y su boton de acciones
		// (menuItem = Submenu)
		...
		// Se le pone a menuItemNuevaReparacion tipo de letra y diseño y se agrega a
		// menuVentas
		menuItemNuevaReparacion.setFont(fuente);
		menuReparacion.add(menuItemNuevaReparacion);

		// Se crea menuItemPruebasReparacion para Reparacion y su boton de acciones
		// (menuItem = Submenu)
		...
		// Se le pone a menuItemPruebasReparacion tipo de letra y diseño y se agrega a
		// menuVentas
		 ...
		 * 
		 * 
		 * MENU PROVEEDORES CON SUS SUBMENUS Nueva proveedor
		 * 
		 ***********************************/

		// Se crea menuItemNuevoProveedor para Proveedor y su boton de acciones
		// (menuItem = Submenu)
		...
		// Se crea panel para poner una etiqueta como texto principal e imagenes para
		// adornar,
		...
		// Se agrega un label a la Ventana, con fuente modificada, (tipo,
		// personalizaciones, tamaño, color) y se da su posicion y tamaño
		...
		// Se agrega una imagen a la ventana principal, se da su posición y tamaño, con
		// la ruta de la imagen y se agrega al panel
		JLabel lblIcono = new JLabel(
				new ImageIcon(VentanaPrincipal.class.getResource("/mx/uam/ingsof/imagen/logoComputadora.png")));
